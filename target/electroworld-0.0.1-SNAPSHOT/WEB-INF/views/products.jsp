...
<style>
body {
   background: url(resources/images/MU_Urbane.jpg) no-repeat center center fixed; 
...
<input type="text" ng-model="data.ProductPrice" />		
 -->
	...
	<div class="jumbotron text-left" style="color:white ; text-align:center">
		<h1 style="color:black">Get products here!</h1>
	</div>

	
 <br><br><br><br>
 		<div align="right">
 			<a href="addproduct"><button type="button" class="btn btn-success btn-md">Add Product</button></a>
		</div>
	 <form align="center">
